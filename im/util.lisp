...
(defun color-mode-alpha-p (color-mode)
  (logtest color-mode (cffi:foreign-bitfield-value 'im-cffi::color-mode-config :color-mode-config-alpha)))

(defun color-mode-packed-p (color-mode)
  (logtest color-mode (cffi:foreign-bitfield-value 'im-cffi::color-mode-config :color-mode-config-packed)))

(defun color-mode-top-down-p (color-mode)
  (logtest color-mode (cffi:foreign-bitfield-value 'im-cffi::color-mode-config :color-mode-config-topdown)))
